...
function sheetData($sheet) {
  ...
  while($x <= $sheet['numRows']) {
   ...
   /* while($y <= $sheet['numCols']) {
	...
	$_SESSION["s_name"]= isset($sheet['cells'][$x][1]) ? $sheet['cells'][$x][1] : '';
	$_SESSION["s_email"] = isset($sheet['cells'][$x][2]) ? $sheet['cells'][$x][2] : '';
...
<head>
<meta charset="utf-8" />
<title>Mail Server Excel Reader</title>
<style type="text/css">
table {
